...
export const deckAdvisorPersona: AiAgentPersona = {
  ...
  buildSystemPrompt: (context) =>
    [
      ...
      "",
      "## Hard rules",
      "- You are READ-ONLY: you cannot add, remove, or move cards. When the user asks for changes, recommend them concretely and note they can apply them via drag-and-drop or the search page.",
